package com.khinthirisoe.popularmoviesappstage1.ui.overview.view
...
import com.khinthirisoe.popularmoviesappstage1.di.component.DaggerActivityComponent
import com.khinthirisoe.popularmoviesappstage1.di.module.ActivityModule
import com.khinthirisoe.popularmoviesappstage1.core.base.BaseActivity
        ...
        mRecyclerView.addOnScrollListener(object : RecyclerView.OnScrollListener() {
            override fun onScrolled(recyclerView: RecyclerView, dx: Int, dy: Int) {
                ...
                if (visibleItemCount + lastVisibleItem >= totalItemCount && !isLoading) {
                    pageNumber++
                    presenter.loadMoviesList(loadPreference(), pageNumber, PrefUtils.getApiKey(this@MovieActivity))
                    isLoading = true
                }
            }
        })
